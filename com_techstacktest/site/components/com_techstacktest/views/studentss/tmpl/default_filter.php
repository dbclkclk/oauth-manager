	...
	<div class="clearfix">
		<div class="js-stools-container-bar">
			<label for="filter_search" class="element-invisible"
				aria-invalid="false"><?php echo JText::_('COM_TEACHPRO_SEARCH_FILTER_SUBMIT'); ?>
                        </label>
			...
			<div class="btn-wrapper input-append">
				...
				<?php echo $filters['filter_search']->input; ?>
                        ...
                        <div class="btn-wrapper">
                            <button type="submit" class="btn hasTooltip" title="" data-original-title="<?php echo JText::_('COM_TEACHPRO_SEARCH_FILTER_SUBMIT'); ?>">
			...
			<?php if ($filters): ?>
				<div class="btn-wrapper hidden-phone">
					<button type="button" class="btn hasTooltip js-stools-btn-filter" title=""
						data-original-title="<?php echo JText::_('COM_TEACHPRO_SEARCH_TOOLS_DESC'); ?>">
						<?php echo JText::_('COM_TEACHPRO_SEARCH_TOOLS'); ?> <i class="caret"></i>
					</button>
				</div>
			<?php endif; ?>
			...
			<div class="btn-wrapper">
				<button type="button" class="btn hasTooltip js-stools-btn-clear" title=""
					data-original-title="<?php echo JText::_('COM_TEACHPRO_SEARCH_FILTER_CLEAR'); ?>"
					onclick="jQuery(this).closest('form').find('input').val('');">
					<?php echo JText::_('COM_TEACHPRO_SEARCH_FILTER_CLEAR'); ?>
				</button>
			</div>
                    
                    
                    <div class="btn-wrapper">
                    <a class="btn btn-success" href="<?php echo JRoute::_('index.php?option=com_teachpro&task=studentsform.edit'); ?>" type="button"><i class="glyphicon glyphicon-plus-sign"></i> Add Student</a>
