 ...
 * @since  1.6
 */
class TeachproModelResponsess extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__teachpro_response` AS a');
	...
	private function isValidDate($date)
	{
        ...
        public function getItemsByTestId ($testId)
        {
            $db = JFactory::getDbo();
            $query = $this->getListQuery();
            
            $query->where("a.testid=".(int) $testId);
