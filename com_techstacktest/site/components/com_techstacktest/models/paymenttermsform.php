 ...
 * @since  1.6
 */
class TeachproModelPaymenttermsForm extends JModelForm
{
	private $item = null;
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_teachpro.edit.paymentterms.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_teachpro.edit.paymentterms.id', $id);
		}
		...
		{
			$this->setState('paymentterms.id', $params_array['item_id']);
		}
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int) $this->getState('paymentterms.id');
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_teachpro.paymentterms', 'enrollment', array(
			'control'   => 'jform',
			'load_data' => $loadData
			)
		);
	...
	{
		$data = JFactory::getApplication()->getUserState('com_teachpro.edit.paymentterms.data', array());
	...
	{
		$id    = (!empty($data['id'])) ? $data['id'] : (int) $this->getState('paymentterms.id');
