 ...
 * @since  1.6
 */
class TeachproModelPaymentForm extends JModelForm
{
	private $item = null;
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_teachpro.edit.payment.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_teachpro.edit.payment.id', $id);
		}
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_teachpro.paymentterms', 'payment', array(
			'control'   => 'jform',
			'load_data' => $loadData
			)
		);		// Get the form.
	...
	{
		$data = JFactory::getApplication()->getUserState('com_teachpro.edit.payment.data', array());
