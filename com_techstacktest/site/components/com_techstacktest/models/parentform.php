 ...
 * @since  1.6
 */
class TeachproModelParentForm extends JModelForm
{
	private $item = null;
	...
	protected function populateState()
	{
		...
		{
			$id = JFactory::getApplication()->getUserState('com_teachpro.edit.parent.id');
		}
		else
		{
			$id = JFactory::getApplication()->input->get('id');
			JFactory::getApplication()->setUserState('com_teachpro.edit.parent.id', $id);
		}
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		$form = $this->loadForm('com_teachpro.parent', 'enrollment', array(
			'control'   => 'jform',
			'load_data' => $loadData
			)
		);
	...
	{
		$data = JFactory::getApplication()->getUserState('com_teachpro.edit.parent.data', array());
