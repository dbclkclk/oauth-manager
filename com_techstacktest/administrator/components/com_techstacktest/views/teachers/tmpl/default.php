...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_teachpro&task=studentss.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_teachpro&view=teacheravailability&layout=edit'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="studentsList">
                    <thead>
                        <tr>
                            ...
                            <th class='left'>
                                <?php echo JHtml::_('grid.sort',  'COM_TEACHPRO_TEACHERS_ID', 'a.`id`', $listDirn, $listOrder); ?>
                            </th>
                            <th class='left'>
                                <?php echo JHtml::_('grid.sort',  'COM_TEACHPRO_TEACHERS_NAME', 'a.`name`', $listDirn, $listOrder); ?>
                            </th>
                            <th class='left'>
                                <?php echo JHtml::_('grid.sort',  'COM_TEACHPRO_TEACHERS_SUBJECT', 'a.`subject`', $listDirn, $listOrder); ?>
                            </th>
                            <th class='left'>
                                <?php echo JHtml::_('grid.sort',  'COM_TEACHPRO_TEACHERS_GRADE', 'a.`grade`', $listDirn, $listOrder); ?>
                            </th>
                        </tr>
                    </thead>
                    <tfoot>
			...
			<tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
				<?php if ($canEdit) : ?>
                                    <a href="<?php echo JRoute::_('index.php?option=com_teachpro&task=teacheravailability.edit&cid[]='.(int) $item->subjectid."&cid[]=".(int) $item->id); ?>">
