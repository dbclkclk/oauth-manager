...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'timesheet.cancel') {
			Joomla.submitform(task, document.getElementById('students-form'));
		}
		else {
			
			if (task != 'timesheet.cancel' && document.formvalidator.isValid(document.id('students-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_teachpro&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_TEACHPRO_TITLE_TIMESHEET', true)); ?>
		<div class="row-fluid">
