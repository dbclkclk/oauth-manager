 ...
 * @since  1.6
 */
class TechstackViewTests extends JViewLegacy
{
	...
	protected function getGoals($id)
	{
                ...
                $testModel = JModelList::getInstance('Tests', 'TechstackModel', array('ignore_request'=>true));

                $testModel->setState('list.ordering', 'ordering');
                $testModel->setState('list.direction', 'ASC');
            
                
		return $this->tests = $testModel->getGoalsBySubject($id);
	...
	protected function addToolbar($layout)
	{
		...
		JToolBarHelper::title(JText::_('COM_TEACHPRO_TITLE_SUBJECTS'), 'subjects.png');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`subject_name`' => JText::_('COM_TEACHPRO_STUDENTSS_FIRSTNAME')
		);
	}
}