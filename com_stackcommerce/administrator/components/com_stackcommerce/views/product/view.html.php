 ...
 * @since  1.6
 */
class StackcommerceViewProduct extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_STACKCOMMERCE_TITLE_PRODUCT'), 'product.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_stackcommerce.product', $this->item->id);
		}
