 ...
 * @since  1.6
 */
class StackcommerceViewProducts extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		StackcommerceHelpersStackcommerce::addSubmenu('products');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_STACKCOMMERCE_TITLE_PRODUCTS'), 'products.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_stackcommerce&view=products');
